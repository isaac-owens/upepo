...
/*!*******************************!*\
  !*** ./src/scripts/canvas.js ***!
  \*******************************/
/*! exports provided: webcam, canvasSource, contextSource, canvasBlended, contextBlended */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"webcam\", function() { return webcam; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"canvasSource\", function() { return canvasSource; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"contextSource\", function() { return contextSource; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"canvasBlended\", function() { return canvasBlended; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"contextBlended\", function() { return contextBlended; });\n// BLUE BOX\nvar webcam = document.getElementById(\"webcam\"); // RED BOX\n\nvar canvasSource = document.getElementById(\"canvas-source\");\nvar contextSource = canvasSource.getContext(\"2d\"); // GREEN BOX\n\nvar canvasBlended = document.getElementById(\"canvas-blended\");\nvar contextBlended = canvasBlended.getContext(\"2d\");\n\n//# sourceURL=webpack:///./src/scripts/canvas.js?");
...
/*!******************************!*\
  !*** ./src/scripts/sound.js ***!
  \******************************/
/*! exports provided: AudioContext, audioCtx, getFile, setupSample, playSample, stopSample, backgroundAudioCtx */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!******************************!*\
  !*** ./src/scripts/video.js ***!
  \******************************/
/*! exports provided: drawVideo, blend, checkArea */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"drawVideo\", function() { return drawVideo; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"blend\", function() { return blend; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"checkArea\", function() { return checkArea; });\n/* harmony import */ var _video_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./video_utils */ \"./src/scripts/video_utils.js\");\n/* harmony import */ var _sound__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sound */ \"./src/scripts/sound.js\");\n/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canvas */ \"./src/scripts/canvas.js\");\n\n\n\nvar timeOut, lastImageData; // render reversed video for mirror effect\n\n_canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].translate(_canvas__WEBPACK_IMPORTED_MODULE_2__[\"canvasSource\"].width, 0);\n_canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].scale(-1, 1);\nfunction drawVideo() {\n  _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].drawImage(_canvas__WEBPACK_IMPORTED_MODULE_2__[\"webcam\"], 0, 0, _canvas__WEBPACK_IMPORTED_MODULE_2__[\"webcam\"].width, _canvas__WEBPACK_IMPORTED_MODULE_2__[\"webcam\"].height);\n}\nfunction blend() {\n  var canvasWidth = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"canvasSource\"].width;\n  var canvasHeight = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"canvasSource\"].height; // ImageData = array of pixels\n  // .getImageData returns ImageData object that copies pixel data\n  // for specified rectangle of canvas context\n\n  var sourceData = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].getImageData(0, 0, canvasWidth, canvasHeight); // creates an image if no previous image exists (i.e. first frame of stream)\n\n  if (!lastImageData) lastImageData = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].getImageData(0, 0, canvasWidth, canvasHeight); // create ImageData instance to get blended result\n\n  var blendedData = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextSource\"].createImageData(canvasWidth, canvasHeight); // blend the images\n\n  _video_utils__WEBPACK_IMPORTED_MODULE_0__[\"difference\"](blendedData.data, sourceData.data, lastImageData.data); // draw the result of the blend\n\n  _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextBlended\"].putImageData(blendedData, 0, 0); // save the current image\n\n  lastImageData = sourceData;\n}\nfunction checkArea() {\n  // still need to define properties of test area\n  var test = document.getElementById(\"test-area\");\n  window.test = test;\n  var rect = test.getClientRects();\n  var testArea = {\n    x: rect[0].x - 330,\n    y: rect[0].y,\n    width: test.clientWidth,\n    height: test.clientHeight\n  };\n  window.testArea = testArea;\n  var blendedData = _canvas__WEBPACK_IMPORTED_MODULE_2__[\"contextBlended\"].getImageData(testArea.x, testArea.y, testArea.width, testArea.height);\n  var i = 0;\n  var average = 0; // loop over the pixels\n\n  while (i < blendedData.data.length * 0.25) {\n    // find average of the color channel values (red, green, blue)\n    average += (blendedData.data[i * 4] + blendedData.data[i * 4 + 1] + blendedData.data[i * 4 + 2]) / 3;\n    i++;\n  } // calculate average of test area color values\n\n\n  average = Math.round(average / (blendedData.data.length * 0.25));\n  window.blendedData = blendedData;\n  window.average = average;\n\n  if (average > 10) {\n    // if average is over the threshold movement has happened\n    _sound__WEBPACK_IMPORTED_MODULE_1__[\"setupSample\"](window.currentInstrument).then(function (sample) {\n      // load and play current instrument's sample\n      _sound__WEBPACK_IMPORTED_MODULE_1__[\"playSample\"](_sound__WEBPACK_IMPORTED_MODULE_1__[\"audioCtx\"], sample);\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/scripts/video.js?");

/***/ }),

/***/ "./src/scripts/video_utils.js":
/*!************************************!*\
  !*** ./src/scripts/video_utils.js ***!
  \************************************/
